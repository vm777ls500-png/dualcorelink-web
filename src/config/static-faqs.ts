...
export const arabicStaticFaqCategories: StaticFaqCategory[] = [
  {
    ...
    items: [
      ...
      { question: "هل أنتم مصنع أم شركة تجارية؟", answer: "لسنا شركة تجارة بسيطة؛ تتركز قوتنا في تصميم الحلول وتخطيط المنتجات وملاءمة المشروع ودعم التكامل، بينما يتم التصنيع لدى شركاء OEM مختارين." },
  ...
  },
  {
    ...
    slug: "products-solutions",
    items: [
      { question: "ما المنتجات التي توفرونها؟", answer: "نوفر شاشات تحكم ذكية ومضيفات RCU ولوحات ذكية ومستشعرات ولوحات ستائر ومقابس ولوحات خدمة فندقية وحلول روبوتات التوصيل." },
  ...
  },
  {
    ...
    items: [
      ...
      { question: "هل تدعمون تشغيل مشروع الفندق؟", answer: "يمكن دعم تنسيق المشروع ومطابقة المنتجات وإرشادات التوصيل، ويُحدد أسلوب الدعم حسب النطاق." },
      { question: "هل تدعمون متطلبات RCU للفنادق؟", answer: "نعم، ويمكن أن تشمل مضيفات RCU واللوحات والمستشعرات والثرموستات والستائر ولوحات الخدمة." },
