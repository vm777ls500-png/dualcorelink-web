  ...
  if (locale === "ar") {
    return filePage(locale, {
      ...
      structuredContent: {
        ...
        introduction:
          "تجمع هذه المكتبة خمسة عشر دليلاً عربياً مستقلاً لمساعدة مالك الفندق والمقاول ومتكامل الأنظمة والمشتري على اتخاذ قرارات RCU واللوحات والمستشعرات والأسلاك وOEM/ODM والتجديد. يبدأ كل دليل من سؤال شراء أو قرار هندسي، ويبيّن المعلومات التي يجب تأكيدها من دون إضافة مواصفات أو نتائج غير موثقة.",
        ...
        cta: {
          heading: "حوّل البحث إلى قائمة متطلبات جاهزة لطلب السعر",
          description:
