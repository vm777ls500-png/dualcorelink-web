...
test("runtime sources are complete and identify plugin version 1.3.1", async () => {
  assert.equal(pluginVersion, "1.3.1");
  ...
  assert.match(pluginHeader.bytes.toString("utf8"), /Version: 1\.3\.1/);
